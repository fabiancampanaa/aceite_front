  ...
  const subirArchivo = async (
    ...
    try {
      ...
      if (respuesta.ok) {
        ...
        if (nombreCampo === "archivo1") setArchivo1(null);
        else if (nombreCampo === "archivo2") setArchivo2(null);
      } else {
    ...
    <div>
      ...
      <div className="container mt-5">
        ...
        <div className="box">
          ...
          {error1 && (
            <div className="notification is-danger mt-3">{error1}</div>
          )}
        </div>
        ...
        <div className="box">
          ...
          {error2 && (
            <div className="notification is-danger mt-3">{error2}</div>
          )}
        </div>
      </div>
    </div>
